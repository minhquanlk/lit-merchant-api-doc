        ...
        i18n: {
            vi: {
                ...
                sections: [
                    ...
                    {
                        type: "endpoint",
                        title: "Endpoint áp dụng",
                        method: "POST",
                        path: "/upay/v2/precreate",
                        text: "Tạo đơn thanh toán QR dynamic và nhận `qr_code` để hiển thị trong frame LIT Merchant.",
                    },
                    {
                        type: "endpoint",
                        title: "Endpoint áp dụng",
                        method: "POST",
                        path: "/upay/v2/pay",
                        text: "Thực hiện thanh toán khi POS hoặc máy quét đọc QR/barcode thanh toán của khách hàng vào `dynamic_id`.",
                    },
                    {
                        type: "endpoint",
                        title: "Endpoint áp dụng",
                        method: "POST",
                        path: "/upay/v2/query",
                        text: "Tra cứu trạng thái giao dịch bằng `sn` hoặc `client_sn` sau khi tạo thanh toán.",
                    },
                    {
                        type: "flow",
                        ...
                        items: [
                            ...
                            "Tính `MD5(sign_input)` và lấy hex lowercase 32 ký tự.",
            ...
            en: {
                ...
                sections: [
                    ...
                    {
                        type: "endpoint",
                        title: "Applicable endpoint",
                        method: "POST",
                        path: "/upay/v2/precreate",
                        text: "Create a dynamic QR payment order and receive `qr_code` for display inside the LIT Merchant frame.",
                    },
                    {
                        type: "endpoint",
                        title: "Applicable endpoint",
                        method: "POST",
                        path: "/upay/v2/pay",
                        text: "Create a payment when the POS or scanner reads the customer's payment QR/barcode into `dynamic_id`.",
                    },
                    {
                        type: "endpoint",
                        title: "Applicable endpoint",
                        method: "POST",
                        path: "/upay/v2/query",
                        text: "Query transaction status by `sn` or `client_sn` after payment creation.",
                    },
                    {
                        type: "flow",
                        title: "Signing steps",
                        items: [
                            ...
                            "Calculate `MD5(sign_input)` and use the 32-character lowercase hex digest.",
            ...
            zh: {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        method: "POST",
                        path: "/upay/v2/precreate",
                        text: "创建动态二维码支付订单，并获取用于展示到 LIT Merchant 框架内的 `qr_code`。",
                    },
                    {
                        type: "endpoint",
                        title: "适用接口",
                        method: "POST",
                        path: "/upay/v2/pay",
                        text: "POS 或扫码枪读取客户付款码到 `dynamic_id` 后，调用该接口发起支付。",
                    },
                    {
                        type: "endpoint",
                        title: "适用接口",
                        method: "POST",
                        path: "/upay/v2/query",
                        text: "支付创建后，通过 `sn` 或 `client_sn` 查询交易状态。",
                    },
                    {
                        type: "flow",
                        title: "签名方法",
                        items: [
                            ...
                            "计算 `MD5(sign_input)`，使用 32 位小写十六进制摘要。",
